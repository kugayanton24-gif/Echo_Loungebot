...
LINKS = {
    ...
    BTN_LOYALTY: "https://loyal.ws/d/699f33dd647328c6f9249a9f/echopoolclub",         # заміниш на лінк лояльності (wallet/google pay)
...
# ================== TEXTS ==================
TEXT_LOYALTY = (
    "Ставайте частиною закритого клубу Echo & Pool Club🤍\n\n"
